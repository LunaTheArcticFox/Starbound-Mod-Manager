...
public class Mod {
	...
	private static final String installedImage = Mod.class.getClassLoader().getResource("installed.png").toExternalForm();
	private static final String notInstalledImage = Mod.class.getClassLoader().getResource("notinstalled.png").toExternalForm();
	private static final String conflictImage = Mod.class.getClassLoader().getResource("conflict.png").toExternalForm();
