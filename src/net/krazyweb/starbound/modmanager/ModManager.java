...
import net.krazyweb.starbound.modmanager.Configuration.KeyValuePair;
...
>>>>>>> 502a3760c9fb3663e4ca94ee8e1b84cfceadf33c
		...
		s.getStylesheets().add(ModManager.class.getClassLoader().getResource("test.css").toExternalForm());
